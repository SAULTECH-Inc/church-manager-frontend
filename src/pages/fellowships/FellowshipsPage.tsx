  ...
  return (
    <div style={{ padding: '24px 32px', minHeight: '100vh', backgroundColor: '#131326' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        <div>
          <h1 style={{ color: 'white', fontWeight: 700, fontSize: 24, margin: 0 }}>Fellowship Management</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginTop: 24 }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13 }}>Total Groups</div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13 }}>Members in Fellowships</div>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 13 }}>Average Attendance</div>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        style={{ backgroundColor: '#13152e', borderColor: 'rgba(255,255,255,0.08)' }}
      >
        <div className="overflow-x-auto">
            ...
            <tbody>
              {isLoading
                ? Array.from({ length: 5 }).map((_, i) => (
                    <tr key={i} className="border-b animate-pulse" style={{ borderColor: 'rgba(255,255,255,0.04)' }}>
                      <td className="px-5 py-4">
                        <div style={{ width: 15, height: 15, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 3 }} />
                      </td>
                      {Array.from({ length: 8 }).map((_, j) => (
                        <td key={j} className="px-5 py-4">
                          <div style={{ height: 14, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 6, width: '70%' }} />
                        </td>
                      ))}
                    </tr>
                  ))
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-4 text-center">
                          <span style={{ color: 'white', fontWeight: 500 }}>{stats.memberCount}</span>
                        </td>
                        <td className="px-5 py-4">
          ...
          {!isLoading && filteredGroups.length === 0 && (
            <div className="py-20 text-center">
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 15, marginBottom: 16 }}>No fellowship groups</p>
              <button
                onClick={() => setDrawerOpen(true)}
                style={{
                  background: 'linear-gradient(135deg, #7c6bff, #6456e8)',
      ...
      {selected.length > 0 && (
        ...
        >
          <span style={{ color: 'white', fontWeight: 500, fontSize: 14 }}>{selected.length} selected</span>
          <button
            style={{
      ...
      >
        ...
        >
          <h2 style={{ color: 'white', fontWeight: 700, fontSize: 18, margin: 0 }}>Create Group</h2>
          <button
        ...
        >
          ...
          <button
            ...
            style={{
              background: createMutation.isPending ? 'rgba(124,107,255,0.5)' : 'linear-gradient(135deg, #7c6bff, #6456e8)',
              color: 'white',
              border: 'none',
              borderRadius: 10,
              padding: '10px 20px',
